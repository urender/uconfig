...
{% 	if (interface.role == 'downstream' && interface?.ipv4?.disallow_upstream_subnet):
		if (type(interface.ipv4.disallow_upstream_subnet) == 'bool' &&
		    interface.ipv4.disallow_upstream_subnet)
			interface.ipv4.disallow_upstream_subnet = [ '192.168.0.0/16', '172.16.0.0/12', '10.0.0.0/8' ];
